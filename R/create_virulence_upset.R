    ...
    upset_plot <- upset(
      ...
      base_annotations = list(
        'Frequency' = intersection_size(
          aes(fill = as.factor(`virulence_score`))
        ) +
          scale_fill_manual(name = "Virulence score", values = c("0" = "midnightblue", "1" = "mediumblue", "2" = "dodgerblue2", "3" = "deeppink3", "4" = "maroon3", "5" = "deeppink4"))
      )
    )
